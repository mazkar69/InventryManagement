...
class SalesClass:
    def __init__(self,root):
        ...
        #=========Title================
        lbl_title=Label(self.root,text="View Coustumer Bills",font=("Goudy old style",30,),bg="#184a45",fg="white",bd=3,relief=RIDGE).pack(side=TOP,fill=X,padx=10,pady=20) 

        lbl_invoice=Label(self.root,text="Invoice No",font=("times new roman",15),bg="white").place(x=50,y=100)

        self.txt_invoice=Entry(self.root,text="Invoice No",textvariable=self.var_invoice,bg="lightyellow",font=("times new roman",15))
        ...
        lbl_title2=Label(bill_frame,text="Coustumer Bills Area",font=("Goudy old style",20,),bg="orange").pack(side=TOP,fill=X) 
