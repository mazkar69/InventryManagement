...
class BillClass:
    def __init__(self,root):
        ...
        lbl_name=Label(CustomerFrame,text="Nmae",font=("times new roman",15),background="white").place(x=5,y=35)
    ...
    def getdata(self,ev):           #Taking the data form product to entry field
        ...
        contant=(self.product_details.item(f))        #contant variable contain the data of that column as a dictnary
    ...
    def get_data(self,ev):              # taking the data From product cart to entry field
        ...
        contant=(self.cart_details.item(f))        #contant variable contain the data of that column as a dictnary
        row=contant["values"]  
        self.var_pid.set(row[0])
        self.var_pname.set(row[1])
        self.var_price.set(row[2])
    ...
    def genrate_bill(self):
        ...
        if self.var_cname.get()=="" or self.var_contact.get()=="":
            ...
            messagebox.showinfo("Success","Bill genrated and saved successfully",parent=self.root)
            self.chk_print=1
    ...
    def bill_top(self):
        ...
        bill_top_temp=f'''
\t\tXYZ-Inventory
\t Phone No. {self.var_contact.get()} , Delhi-125001
{str("="*45)}
...
{str("="*45)}\n
    ...
    def print_bill(self):
        if(self.chk_print==1):
            ...
            messagebox.showerror("Error","First Genrate the bill!")
