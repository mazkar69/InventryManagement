...
class SupplierClass:
    def __init__(self,root):
        ...
        self.supliertable=ttk.Treeview(supframe,columns=("sup_id","invoice_no","name","contact","description"),yscrollcommand=scrolly.set,xscrollcommand=scrollx.set)
        ...
        self.supliertable.heading("description",text="Discription")
        ...
        self.supliertable.column("description",width=100)
        ...
        if self.var_invoice.get()=="" or self.var_supplier_name.get()=="":
            ...
            try:
                ...
                if row!=None:
                    ...
                    cur.execute("insert into supplier (invoice_no,name,contact,description) values(?,?,?,?)",(self.var_invoice.get(),self.var_supplier_name.get(),self.var_contact.get(),self.txt_description.get(1.0,END)))
                    con.commit()
